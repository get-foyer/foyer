...
- `foyer` / `foyer-lobby` CLI with a guided `setup` wizard and `uninstall` flow.
...
- Local-first security model: binds to `127.0.0.1`, no auth, credentials stored under
  `~/.config/foyer-lobby/config.env` ([SECURITY.md](SECURITY.md)).

[Unreleased]: https://github.com/get-foyer/lobby/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/get-foyer/lobby/releases/tag/v0.1.0
